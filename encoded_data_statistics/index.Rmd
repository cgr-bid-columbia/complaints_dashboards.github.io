...
fig <- plot_ly(data_plot, x = ~date_batch, y = ~error_rate_andrea, type = 'bar',  name = 'error_rate_andrea',
                marker = list(color = 'rgb(158,202,225)') )
fig <- fig %>% add_trace(y = ~error_rate_edwar, name = 'error_rate_edwar',
                marker = list(color = 'springgreen4') )         

fig <- fig %>% 
        layout(title = "Error rate per encoder and date batch",
