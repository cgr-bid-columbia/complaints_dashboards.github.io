...
#raw_claims_feb21 <- mutate(raw_claims_feb21, accept_claim =
                                 #  case_when(FUR_decision == "Accept" ~ 1,
                                  #           FUR_decision != "Accept" ~ 0 ) )
...
#creating alarm var 
#raw_claims_feb21$alarm<- ifelse(raw_claims_feb21$producto_propuesto=='Carpeta Atención de Denuncia', 1, NA)
...
```{r}
# number and percentage of claims per type of entity
