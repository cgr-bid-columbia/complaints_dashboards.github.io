...
raw_claims_feb21 <- mutate(raw_claims_feb21, FUR_decision_categories =
                                   case_when(estado_hec == "Calificado" | estado_hec == "Concluido" ~ "Aprobado",
                                             estado_hec == "Anulado"  ~ "Rechazado",
                                             estado_hec == "En Proceso" | estado_hec == "Pendiente" ~ "Pendiente" ) )
...
table(raw_claims_feb21$estado_fud)
#table(raw_claims_feb21$FUD_decision[raw_claims_feb21$estado_fud=="Desestimado"])
#table(raw_claims_feb21$FUD_decision[raw_claims_feb21$estado_fud=="Sin atender"])
#table(raw_claims_feb21$FUD_decision[raw_claims_feb21$estado_fud=="Devuelto"])
#table(raw_claims_feb21$FUD_decision[raw_claims_feb21$estado_fud=="Asociado"])

#raw_claims_feb21 <- mutate(raw_claims_feb21, FUD_decision_categories =
#                                   case_when(estado_fud == "Desestimado" 
...
raw_claims_feb21 <- mutate(raw_claims_feb21, PDE_decision_categories =
                                   case_when(producto_aprobado == "Desestimado" ~ "Anulado",
                                             producto_aprobado == "En proceso" & PDE_decision == "Yes" ~ "Pendiente",
                                             producto_aprobado == "Carpeta Atención de Denuncia" & PDE_decision == "Yes" ~ "Aprobado"
                                   ) )
