...
### <b><font face="Arial" size="4px" color="#000000">Encoded Claims: XX</font></b>  
...
tbl <- reactable(
  ...
  columns = list(
    ...
    n_fur = colDef(name = "FUR"),
    n_fud = colDef(name = "FUD"),
    n_pde = colDef(name = "PDE"),
    n_cad = colDef(name = "CAD")
  )
)
...
tbl <- reactable(
  ...
  columns = list(
    ...
    assigned_AOC = colDef(
      ...
      # Render the bar charts using a custom cell render function
      cell = function(value) {
        width <- paste0(value * 100 / max(AOC_entity_count$assigned_AOC), "%")
        # Add thousands separators
        value <- format(value, big.mark = ",")
        bar_chart(value, width = width, fill = "#3fc1c9")
      },
