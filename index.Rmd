...
raw_claims_feb21 <- mutate(raw_claims_feb21, ARA_decision =
                                   case_when(estado_fur == "Aceptado a trámite" | estado_fur == "Admitido" ~ "Accept",
                                             estado_fur == "Derivado" ~ "Derive",
                                             estado_fur == "Desestimado" | estado_fur == "Devuelto" | estado_fur == "No aceptado a trámite" | estado_fur == "No admitido" ~ "Reject",
                                             estado_fur == "En evaluación" | estado_fur == "Pendiente" ~ "Waiting" ) )
...
fig <- fur_status_df %>% plot_ly(labels = ~fur_status, values = ~n, marker = list(colors = c('#00aa7f', '#ff0000','#ccccc7', "#2675fc" )))
fig <- fig %>% add_pie(hole = 0.55, textfont = list(size = 15))
