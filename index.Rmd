...
#clean_claims_21 <-import("clean_claims21_v4.dta")
...
#tie_breaking_append$error_ganet <- rep(0, nrow(tie_breaking_append))
#tie_breaking_append$error_ganet[tie_breaking_append$chosen_encoder != "Ganet" & tie_breaking_append$chosen_encoder != "Ganet/Edwar"] <- 1
...
#df_ganet <- aggregate(tie_breaking_append$error_ganet, by=list(date_batch=tie_breaking_append$date_batch), FUN=sum)

#colnames(df_ganet)[2] <- "error_ganet"
...
#df_error_rate = merge(df_error_rate, df_ganet, by = "date_batch", all.x = TRUE)
...
#df_error_rate$error_rate_ganet <- round( (df_error_rate$error_ganet/df_error_rate$obs)*100 , 1)
...
#df_ganet_rate = df_error_rate[c('date_batch','error_rate_ganet')]



data_plot <- merge(df_andrea_rate, df_edwar_rate, by = "date_batch")
#data_plot <- merge(data_plot, df_ganet_rate, by = "date_batch")
